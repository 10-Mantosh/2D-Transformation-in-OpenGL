...
int main(int argc, char** argv)
{
    ...
    xr=(p1[0][0]+p2[0][0]+p3[0][0]+p4[0][0]+p5[0][0]+p6[0][0])/6;//centriod calculation
    yr=(p1[1][0]+p2[1][0]+p3[1][0]+p4[0][0]+p5[0][0]+p6[0][0])/6;//you need to change only this two formula
